...
export type GeneratedDocDoc =
  mongoose.InferSchemaType<typeof GeneratedDocSchema> & {
    _id: mongoose.Types.ObjectId;
  };

export const GeneratedDoc =
  models.GeneratedDoc || model('GeneratedDoc', GeneratedDocSchema);